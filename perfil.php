				...
				<div class="col-md-6 px-3">
					<div class="row pl-3">
						...
						<div class="col-md-8">
							...
							<h1 class="text-white py-2">Nombre completo</h1>
							<p class="text-white py-1">Descripcion</p>
							<ul class="text-white">
								<li class="text-muted">Email: <strong class="text-white">Correo</strong></li>
								<li class="text-muted">Profesión: <strong class="text-white">Profesion</strong></li>
								<li class="text-muted">Especialidad: <strong class="text-white">Especialidad</strong></li>
								<li class="text-muted">Ciudad: <strong class="text-white">Ciudad</strong></li>
							</ul>
							<a href="https://wa.me/57" class="btn btn-outline-success">Contactar &nbsp; <i class="fab fa-whatsapp"></i></a>
						</div>
					</div>
					<div class="row pl-3">
						<div class="col-md-12">
